...
public class ModificarUsuario extends JInternalFrame {
    ...
    private JTextField textField_1;    // Correo
    private JTextField textField_2;    // Nickname
    private JTextField textField_3;    // Apellido
    private JTextField textField_4;    // Descripcion
    private JTextField textField_5;    // URL
    private JFormattedTextField campoFecha; // Fecha de nacimiento
    ...
    public ModificarUsuario() {
        ...
        textField_5 = new JTextField(); // URL
