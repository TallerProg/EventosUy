...
public class DTEdicion {
    ...
    public DTEdicion(String nombre, String sigla, LocalDate fInicio, LocalDate fFin,
                     LocalDate fAlta, String ciudad, String pais,
                     List<DTTipoRegistro> tipoRegistros,
                     List<DTOrganizador> organizadores,
    ...
    public List<DTTipoRegistro> getTipoRegistros() { return tipoRegistros; }
    public List<DTOrganizador> getOrganizadores() { return organizadores; }
