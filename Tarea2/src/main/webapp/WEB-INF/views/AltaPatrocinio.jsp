      ...
      <div class="card-body">
        ...
        <form action="<%=ctx%>/organizador-patrocinios-alta" method="post" class="row g-3" id="form-patro">
          ...
          <div class="col-md-6">
            ...
            <small class="text-muted">Podés usar el cálculo sugerido o ingresar el monto que corresponda.</small>
          </div>
...
<!-- Sugerencia en vivo de cantidad (20% del aporte / costo del tipo). El campo queda editable. -->
<script>
(function(){
  const ctx = '<%=ctx%>';
