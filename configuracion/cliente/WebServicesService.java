 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://publicar/", wsdlLocation = "http://localhost:9128/ws?wsdl")
public class WebServicesService
    extends Service
{

    private static final URL WEBSERVICESSERVICE_WSDL_LOCATION;
    private static final WebServiceException WEBSERVICESSERVICE_EXCEPTION;
    private static final QName WEBSERVICESSERVICE_QNAME = new QName("http://publicar/", "WebServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
        	  String wsdl = Conf.get(
                      "ws.publish.url"
                      );
            url = new URL(wsdl);
