...
class AltaTipoRegistroTest {
    ...
    void testAltaTipoRegistroValido() throws Exception {
        ...
        TipoRegistro tre = edicion1.getTipoRegistros().get(0);
        assertEquals("VIP", tre.getNombre());
        assertEquals("Acceso VIP", tre.getDescripcion());
        assertEquals(200f, tre.getCosto());
        assertEquals(50, tre.getCupo());
        assertEquals(edicion1, tre.getEdicion());
    }
