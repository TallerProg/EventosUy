...
public class AltaUsuario extends JInternalFrame {
    ...
    public AltaUsuario(IControllerUsuario icu, IControllerInstitucion ici) {
        ...
        // Aumento la cantidad de filas para dejar espacio a los nuevos campos y dinámicos
        ...
        // ---------- Nuevos campos: Contraseña y Confirmación ----------
        lblPassword = new JLabel("Contraseña:");
        GridBagConstraints gbc_lblPass = new GridBagConstraints();
        gbc_lblPass.insets = new Insets(5, 5, 5, 5);
        gbc_lblPass.gridx = 0;
        gbc_lblPass.gridy = row;
        gbc_lblPass.anchor = GridBagConstraints.EAST;
        getContentPane().add(lblPassword, gbc_lblPass);

        passwordField = new JPasswordField();
        GridBagConstraints gbc_pass = new GridBagConstraints();
        gbc_pass.insets = new Insets(5, 5, 5, 5);
        gbc_pass.fill = GridBagConstraints.HORIZONTAL;
        gbc_pass.gridx = 1;
        gbc_pass.gridy = row;
        getContentPane().add(passwordField, gbc_pass);
        row++;

        lblConfirmPassword = new JLabel("Confirmar contraseña:");
        GridBagConstraints gbc_lblCPass = new GridBagConstraints();
        gbc_lblCPass.insets = new Insets(5, 5, 5, 5);
        gbc_lblCPass.gridx = 0;
        gbc_lblCPass.gridy = row;
        gbc_lblCPass.anchor = GridBagConstraints.EAST;
        getContentPane().add(lblConfirmPassword, gbc_lblCPass);

        confirmPasswordField = new JPasswordField();
        GridBagConstraints gbc_cpass = new GridBagConstraints();
        gbc_cpass.insets = new Insets(5, 5, 5, 5);
        gbc_cpass.fill = GridBagConstraints.HORIZONTAL;
        gbc_cpass.gridx = 1;
        gbc_cpass.gridy = row;
        getContentPane().add(confirmPasswordField, gbc_cpass);
        row++;
        // ---------- Fin nuevos campos ----------
        ...
        btnAceptar.addActionListener(e -> {
            ...
            // Obtengo las contraseñas como String (el usuario pidió String al final)
            ...
            try {
                ...
                if (password.isEmpty() || passwordConfirm.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "La contraseña y su confirmación son obligatorias.",
                            "Campos vacíos", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                if (!password.equals(passwordConfirm)) {
                    JOptionPane.showMessageDialog(this, "Ambas contraseñas deben ser iguales.",
                            "Contraseña no coincide", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                if (tipo.equals("Asistente")) {
                    ...
                    if (fecha.isAfter(LocalDate.now()) || fecha.isEqual(LocalDate.now())) {
                        JOptionPane.showMessageDialog(this,
                                ...
                                "Fecha de nacimiento no válida", JOptionPane.WARNING_MESSAGE);
                        return;
                    }

                    String nombreInstitucion = (String) comboInstitucion.getSelectedItem();
                    Institucion inst = null;
                    if (!"Ninguna".equals(nombreInstitucion)) {
                ...
                // Limpio contraseñas siempre que el alta haya sido exitosa
                passwordField.setText("");
                confirmPasswordField.setText("");
