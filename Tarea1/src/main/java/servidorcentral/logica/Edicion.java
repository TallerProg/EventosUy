...
public class Edicion {
    ...
    public void agregarTipoRegistro(TipoRegistro tre) {
        if (tre != null) {
            tipoRegistros.add(tre);
        }
    }
    ...
    public boolean habilitadoAsistente(String nombreTR, Asistente asistente) throws Exception {
        TipoRegistro tre = getEdicionTR(nombreTR);
        if (tre == null) {
    ...
    public DTTipoRegistro datosTipoRegistroEdicion(String nombreTipoR) {
        TipoRegistro reg = getEdicionTR(nombreTipoR);
        if (reg != null) {
            return reg.getDTTipoRegistro();
        }
        return null; 
    }
