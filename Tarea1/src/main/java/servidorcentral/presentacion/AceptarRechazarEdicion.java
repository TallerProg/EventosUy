...
public class AceptarRechazarEdicion extends JInternalFrame {
	...
	private final IControllerEvento cev;
    ...
    public AceptarRechazarEdicion(IControllerEvento cev) {
        this.cev = cev;
        ...
        btnAceptar .addActionListener(new ActionListener() {
            @Override public void actionPerformed(ActionEvent eve) {
                String edi = (String) comboEdiciones.getSelectedItem();
                if (edi == null) {
                ...
                try {
                    cev.aceptarRechazarEdicion(edi, true);
        ...
        btnRechazar.addActionListener(new ActionListener() {
            @Override public void actionPerformed(ActionEvent eve) {
                ...
                try {
                    cev.aceptarRechazarEdicion(edi, false);
    ...
    public void cargarEventos() {
        try {
            String[] nombres = cev.listarEventos().stream()
    ...
    private void recargarEdicionesIngresadas() {
        ...
        try {
            String[] edIngresadas = cev.listarEdiciones().stream()
                    .filter(ed -> {
