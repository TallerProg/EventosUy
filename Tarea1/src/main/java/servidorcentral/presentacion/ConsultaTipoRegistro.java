...
public class ConsultaTipoRegistro extends JInternalFrame {
	...
	public void cargarDatos(String nombreEdicionSeleccionado, String nombreTipoRegistroSeleccionado ) {
		...
		DTTipoRegistro dtr = controlEvento.consultaTipoRegistro(nombreEdicionSeleccionado, nombreTipoRegistroSeleccionado);
		if (dtr != null) {
		textFieldNombre.setText(dtr.getNombre());
		textField1desc.setText(dtr.getDescripcion());
		textField2costo.setText(String.valueOf(dtr.getCosto()));
		textField3cupo.setText(String.valueOf(dtr.getCupo()));
		}
	}
