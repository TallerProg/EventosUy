	...
	public ConsultarUsuario(IControllerUsuario icu, IControllerEvento ice, JDesktopPane desktopPane) {
		...
		comboBoxUsuario.addActionListener(e -> {
			...
			if (nicknameSeleccionado != null) {
				DTUsuarioListaConsulta dtc = controlUsuario.consultaDeUsuario(nicknameSeleccionado);
				if (dtc == null)
					return;

				textFieldNickname.setText(dtc.getNickname());
				textFieldCorreo.setText(dtc.getCorreo());
				...
				if (usuario instanceof Asistente) {
					...
					textFieldApellido.setText(dtc.getApellido());
					DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
					textFieldFechaNacimiento.setText(dtc.getFNacimiento().format(formatter));
					...
					textFieldDescripcion.setText(dtc.getDescripcion());
					textFieldURL.setText(dtc.getUrl());
				...
				cargarEdiciones(dtc.getEdiciones());
